...
public class GerenciadorMissoes {
    ...
    public GerenciadorMissoes() {
        ...
        /* Adiciona missões */
        missoes.add(new Missao("Missão: Encontre o anel de fogo", 2, 3));
        missoes.add(new Missao("Missão: Encontre a pedra de jade", 3, 4));
        missoes.add(new Missao("Missão: Encontre a lótus cinza", 4, 1));
        missoes.add(new Missao("Missão: Encontre a pedra filosofal", 2, 4));
        missoes.add(new Missao("Missão: Encontre a maça proibida", 3, 5));
        missoes.add(new Missao("Missão: Encontre a entrada do país das maravilhas", 5, 6));
        missoes.add(new Missao("Missão: Encontre a saída de Sántuario", 6, 8));
